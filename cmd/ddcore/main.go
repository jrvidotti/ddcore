...
func load(test bool, dev bool) (*engine.Engine, *config.File, error) {
	...
	e, err := engine.New(context.Background(), engine.Config{
		...
		Port: cfg.Port, SiteName: cfg.Site, Lang: cfg.Lang, Currency: cfg.Currency, Timezone: cfg.Timezone, DataDir: cfg.DataDir, ExportMaxRows: cfg.ExportMaxRows, LogLevel: level,
	})
	return e, cfg, err
}
