...
func load(test bool, dev bool) (*engine.Engine, *config.File, error) {
	...
	e, err := engine.New(context.Background(), engine.Config{
		...
		Auth: cfg.Auth, Ops: cfg.Ops, LogJSON: logJSON(), LogOut: logOut, Mail: cfg.Mail, Webhooks: cfg.Webhooks, SiteURL: cfg.PublicURL(), TrustProxy: cfg.TrustProxy, Login: cfg.Login,
	})
