...
`docs/agent/index.md` (referência da API para escrever apps). Apps de produto vivem em
repositórios separados; um app de exemplo para este repositório será adicionado depois.
